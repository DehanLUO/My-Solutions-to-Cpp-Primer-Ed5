...
#ifndef CHAPTER_14_EXERCISE_26_STRING_H_
#define CHAPTER_14_EXERCISE_26_STRING_H_
...
/**
 * @brief Less-than comparison for String objects
 * @param lhs Left-hand side String
 * @param rhs Right-hand side String
 * @return True if lhs is lexicographically less than rhs
 *
 * Performs lexicographical comparison using C-style string comparison:
 * 1. Compares characters sequentially until a difference is found
 * 2. If all characters match up to the length of the shorter string,
 *    the shorter string is considered less
 * 3. Uses std::strcmp for efficient comparison with null termination
 *
 * Lexicographical order means:
 * - "apple" < "banana" (a < b)
 * - "apple" < "application" (shorter string is less when prefixes match)
 * - "Apple" < "apple" (ASCII: 'A' (65) < 'a' (97))
 *
 * @TimeComplexity O(min(n, m)) where n and m are the lengths of lhs and rhs
 * @SpaceComplexity O(1)
 */
inline bool operator<(const String& lhs, const String& rhs) {
...
/**
 * @brief Greater-than comparison for String objects
 * @param lhs Left-hand side String
 * @param rhs Right-hand side String
...
/**
 * @brief Greater-than-or-equal comparison for String objects
 * @param lhs Left-hand side String
 * @param rhs Right-hand side String
...
/**
 * @brief Less-than-or-equal comparison for String objects
 * @param lhs Left-hand side String
 * @param rhs Right-hand side String
...
#endif  // CHAPTER_14_EXERCISE_26_STRING_H_