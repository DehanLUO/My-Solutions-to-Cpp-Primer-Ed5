/*
 * Exercise 14.17: Should the class you chose for exercise 7.40 from § 7.5.1 (p.
 * 291) define the equality operators? If so, implement them. If not, explain
 * why not.
 */

#ifndef CHAPTER_14_EXERCISE_17_H_
#define CHAPTER_14_EXERCISE_17_H_
...
#endif  // CHAPTER_14_EXERCISE_17_H_
