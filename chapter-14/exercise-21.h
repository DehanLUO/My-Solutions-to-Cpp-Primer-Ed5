...
#ifndef CHAPTER_14_EXERCISE_21_H_
#define CHAPTER_14_EXERCISE_21_H_
...
class Sales_data {
 ...
 public:
   ...
   * @note operator+= calls operator+
   * Time Complexity O(1)
   * Space Complexity O(1)
   */
  Sales_data& operator+=(const Sales_data& rhs) {
    *this = *this + rhs;  // Creates temporary and assigns back
    return *this;
  }
...
#endif  // CHAPTER_14_EXERCISE_21_H_
