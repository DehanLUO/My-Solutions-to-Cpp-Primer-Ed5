/*
 * Exercise 7.50: Determine whether any of your Person class constructors should
 * be explicit.
 */

/*
 * Technical justification:
 * - Single-parameter constructors should generally be explicit
 * - Constructors with "surprising" conversions should be explicit
 * - Maintains type safety in overload resolution
 */

#ifndef CHAPTER_07_EXERCISE_50_H_
#define CHAPTER_07_EXERCISE_50_H_
...
#endif  // CHAPTER_07_EXERCISE_50_H_