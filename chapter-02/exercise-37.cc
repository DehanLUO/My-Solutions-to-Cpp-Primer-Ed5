...
/*
 * $ g++ -o main exercise-37.cc && ./main
 * chapter-02/exercise-37.cc:16:14: warning: expression with side effects has no effect in an unevaluated context [-Wunevaluated-expression]
 *    16 |   decltype(a = b) d = a;
 *       |              ^
 * 1 warning generated.
 * a=3 |type: int
